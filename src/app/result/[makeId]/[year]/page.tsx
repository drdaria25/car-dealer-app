...
export default async function ResultPage({ params }: PageProps) {
  ...
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center h-screen  bg-gradient-to-b  from-gray-800 text-white">
          <Spinner />
        </div>
      }
    >
      <div className="min-h-screen bg-gradient-to-b  from-gray-800 text-white">
